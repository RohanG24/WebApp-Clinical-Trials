...
def _section_overview(protocol: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {"heading": "What is this study about?", "icon": "clipboard", "bullets": bullets}
...
def _section_interventions(protocol: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {"heading": "What is being tested?", "icon": "droplet", "bullets": bullets}
...
def _section_eligibility(protocol: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {"heading": "Who can join?", "icon": "user-check", "bullets": bullets}
...
def _section_contacts(protocol: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {"heading": "Who to contact", "icon": "phone", "bullets": bullets}
